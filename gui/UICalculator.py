...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.sb_n_shots_max, 4, 2, 1, 2)
        self.pb_calc_logbook = QtWidgets.QPushButton(self.groupBox)
        self.pb_calc_logbook.setObjectName("pb_calc_logbook")
        self.gridLayout.addWidget(self.pb_calc_logbook, 4, 4, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.pb_calc_logbook.setText(_translate("Form", "Logbook"))
